...
@SuppressLint("NewApi")
public class SearchPerf_V600 extends ActivityInstrumentationTestCase2 {	 
...
//			android.util.Log.e("yanyuan", "exp: " + e);
	...
	protected void setUp() throws Exception {
		...
		readConfig();
		String strLast = mstrCaseName + "," + ToolKit.getEngineLogTime( LT_UDC_PATH + LT_UDC_FILE , mstrKey );
		ToolKit.loge(strLast);
		ToolKit.writeToFile(PATH, "nettime.csv", strLast, true);
	...
	private void saveConfig(){
		ToolKit.writeToFile(PATH, SEARCHKEY_CFG, mstrCaseName + "," + mstrKey + "\n", false);
	}
...
//		test_RouteSearch_inner1(city, from, to, result, 0);
...
//		test_RouteSearch_inner1(city, from, to, result, 1);
...
//		test_RouteSearch_inner1(city, from, to, result, 2);
