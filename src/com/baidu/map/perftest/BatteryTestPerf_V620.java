...
@SuppressLint("NewApi")
public class BatteryTestPerf_V620 extends ActivityInstrumentationTestCase2 {	 
...
//			android.util.Log.e("yanyuan", "exp: " + e);
	...
	{
//		mToolKit.clickOnViewById(Constant_BatteryTestV620.ID_ONESEARCH_BOX);
		solo.clickOnText("搜索");
	}
...
//		}
	...
	public void getAllID() throws Exception {
		...
		mToolKit.getSingleId(60, 260, RIDConfigV620.NAME_ROUTE_CHANGE_BUTTON );
	}
	...
	public void searchBusRoute() throws Exception{
		...
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV620.ID_ROUTE_BUS_BUTTON);
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV620.ID_ROUTE_CHANGE_BUTTON);
		solo.sleep(PAUSE_TIME);
	...
	public void searchBankPlace() throws Exception{
		...
		solo.clickOnText("到这去");
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV620.ID_ROUTE_CAR_BUTTON);
		solo.sleep(PAUSE_TIME*2);
		solo.clickOnText("搜索");
		solo.sleep(PAUSE_TIME*5);
...
//		testBattery();
	...
	public void testBattery() throws Exception {
		...
		searchBusRoute();
      	searchBankPlace();
      	mToolKit.clickOnViewById(RIDConfigV620.ID_ROUTE_BUTTON);
		solo.sleep(PAUSE_TIME*10);
		for( int i=1; i<=5; i++)
		{
//			mToolKit.clickOnViewById(RIDConfigV620.ID_ZOOM_OUT_BUTTON);// 放大
			solo.clickOnScreen(300, 500, 2);
			solo.sleep(PAUSE_TIME*10);
		}
		mToolKit.clickOnViewById(RIDConfigV620.ID_LAYER_BUTTON);//510.250 
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV620.ID_LAYER_STAR_BUTTON);//点击卫星图
		solo.sleep(PAUSE_TIME*10);
		mToolKit.clickOnViewById(RIDConfigV620.ID_LAYER_BUTTON);
		solo.sleep(PAUSE_TIME);
		for( int i=1; i<=5; i++)
		{
			mToolKit.clickOnViewById(RIDConfigV620.ID_ZOOM_IN_BUTTON);// 缩小
//			solo.multiTouchOnScreen(150, 500, 350, 400);
			solo.sleep(PAUSE_TIME*10);
		}
		mToolKit.clickOnViewById(RIDConfigV620.ID_LAYER_BUTTON);
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV620.ID_LAYER_FLOOT_BUTTON);//点击平面图
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV620.ID_LAYER_BUTTON);
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV620.ID_ROUTE_BUTTON);//关闭路况
		solo.sleep(PAUSE_TIME);
...
//		
	...
	public void ZoomIn( int deltaLv ){
		for( int i = 0; i < deltaLv; i++ ){
			mToolKit.clickOnViewById(RIDConfigV620.ID_ZOOM_IN_BUTTON);
			solo.sleep(PAUSE_TIME);
		}
	}
	...
	public void ZoomOut( int deltaLv ) {
		for( int i = 0; i < deltaLv; i++ ){
			mToolKit.clickOnViewById(RIDConfigV620.ID_ZOOM_OUT_BUTTON);
			solo.sleep(PAUSE_TIME);
		}
	}
	...
	public void test_dragMap()  throws Exception{
		...
		String title = this.getName() + "_" + System.currentTimeMillis() + "_V6_2";
