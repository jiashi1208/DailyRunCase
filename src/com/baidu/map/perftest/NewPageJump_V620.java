...
@SuppressLint("NewApi")
public class NewPageJump_V620 extends ActivityInstrumentationTestCase2 {	 
...
//	private final int ONE_SEARCH_BOX_Y = 360;
	...
	public void getAllID() throws Exception {
		solo.sleep(PAUSE_TIME*2);
		mToolKit.getSingleId(360, 115, RIDConfigV620.NAME_ONESEARCH_BOX );
...
//			mToolKit.sleep(AFTER_WAIT_TIME);
	...
	private final int LCTIME = 30;
	private void camClick( int viewid ){
		myWait(0);
//		mToolKit.clickOnViewById( viewid );
		mToolKit.clickLongOnViewById(viewid, LCTIME);
		myWait(1);
	}
...
//		solo.clickOnText(text);
		solo.clickLongOnText(text, 0, LCTIME);
		myWait(1);
	}
...
//		solo.clickOnScreen(x, y);
		solo.clickLongOnScreen(x, y, LCTIME);
		myWait(1);
	}
...
//		solo.clickInList(line);
		solo.clickLongInList(line, line-1, LCTIME);
		myWait(1);
	}
...
//		solo.clickOnText("查看路线");
	...
	public void oneSearchBox() throws Exception{
		prepare();
		camClick( RIDConfigV620.ID_ONESEARCH_BOX );
		solo.sleep(PAUSE_TIME*3);
		mToolKit.goBack(1);
	}
