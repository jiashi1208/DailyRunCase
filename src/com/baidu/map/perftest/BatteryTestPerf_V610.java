...
@SuppressLint("NewApi")
public class BatteryTestPerf_V610 extends ActivityInstrumentationTestCase2 {	 
...
//		solo.sendKey(Solo.ENTER);
	...
	public void getAllID() throws Exception {
		...
		solo.sleep(PAUSE_TIME);
		mToolKit.getSingleId(130, 450, RIDConfigV610.NAME_LAYER_STAR_BUTTON );
		solo.sleep(PAUSE_TIME);
		mToolKit.getSingleId(360, 450, RIDConfigV610.NAME_LAYER_FLOOT_BUTTON );
		solo.clickOnScreen(660, 320);
		
		mToolKit.getSingleId(660, 240, RIDConfigV610.NAME_ROUTE_BUTTON );
		mToolKit.getSingleId(660, 320, RIDConfigV610.NAME_LAYER_BUTTON );
		
		mToolKit.getSingleId(660, 1020, RIDConfigV610.NAME_ZOOM_OUT_BUTTON );
		mToolKit.getSingleId(660, 1110, RIDConfigV610.NAME_ZOOM_IN_BUTTON );
		...
		mToolKit.getSingleId(60, 260, RIDConfigV610.NAME_ROUTE_CHANGE_BUTTON );
	}
	...
	public void searchBusRoute() throws Exception{
		...
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV610.ID_ROUTE_BUS_BUTTON);
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV610.ID_ROUTE_CHANGE_BUTTON);
		solo.sleep(PAUSE_TIME);
	...
	public void searchBankPlace() throws Exception{
		...
		solo.clickOnText("到这去");
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV610.ID_ROUTE_CAR_BUTTON);
		solo.sleep(PAUSE_TIME*2);
		solo.clickOnText("搜索");
		solo.sleep(PAUSE_TIME*5);
...
//		testBattery();
	...
	public void testBattery() throws Exception {
		...
		searchBusRoute();
      	searchBankPlace();
      	mToolKit.clickOnViewById(RIDConfigV610.ID_ROUTE_BUTTON);
		solo.sleep(PAUSE_TIME*10);
		for( int i=1; i<=5; i++)
		{
			mToolKit.clickOnViewById(RIDConfigV610.ID_ZOOM_OUT_BUTTON);// 放大
			solo.sleep(PAUSE_TIME*10);
		}
		mToolKit.clickOnViewById(RIDConfigV610.ID_LAYER_BUTTON);//510.250 
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV610.ID_LAYER_STAR_BUTTON);//点击卫星图
		solo.sleep(PAUSE_TIME*10);
		mToolKit.clickOnViewById(RIDConfigV610.ID_LAYER_BUTTON);
		solo.sleep(PAUSE_TIME);
		for( int i=1; i<=5; i++)
		{
			mToolKit.clickOnViewById(RIDConfigV610.ID_ZOOM_IN_BUTTON);// 缩小
			solo.sleep(PAUSE_TIME*10);
		}
		mToolKit.clickOnViewById(RIDConfigV610.ID_LAYER_BUTTON);
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV610.ID_LAYER_FLOOT_BUTTON);//点击平面图
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV610.ID_LAYER_BUTTON);
		solo.sleep(PAUSE_TIME);
		mToolKit.clickOnViewById(RIDConfigV610.ID_ROUTE_BUTTON);//关闭路况
		solo.sleep(PAUSE_TIME);
...
//		
	...
	public void ZoomIn( int deltaLv ){
		for( int i = 0; i < deltaLv; i++ ){
			mToolKit.clickOnViewById(RIDConfigV610.ID_ZOOM_IN_BUTTON);
			solo.sleep(PAUSE_TIME);
		}
	}
	...
	public void ZoomOut( int deltaLv ) {
		for( int i = 0; i < deltaLv; i++ ){
			mToolKit.clickOnViewById(RIDConfigV610.ID_ZOOM_OUT_BUTTON);
			solo.sleep(PAUSE_TIME);
		}
	}
	...
	public void test_dragMap()  throws Exception{
		...
		String title = this.getName() + "_" + System.currentTimeMillis() + "_V6_1";
