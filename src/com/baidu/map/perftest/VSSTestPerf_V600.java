...
@SuppressLint("NewApi")
public class VSSTestPerf_V600 extends ActivityInstrumentationTestCase2 {	 
...
//			android.util.Log.e("yanyuan", "exp: " + e);
	...
	private int ID_ONESEARCH_BOX_INNER = RIDConfigV600.ID_ONESEARCH_BOX;
	...
	public void getAllID() throws Exception {
		...
		solo.clickOnText("我的");
		solo.sleep(PAUSE_TIME);
		mToolKit.getSingleId(670, 95, RIDConfigV600.NAME_PERSONAL_SET );
	}
	...
	public void vss_personal(int num)throws Exception{
		solo.clickOnText("我的");
		solo.sleep(PAUSE_TIME);
		for ( int i=1; i<=num; i++)
		{
	...
	public void vss_set(int num)throws Exception{
		...
		for ( int i=1; i<=num; i++)
		{
			mToolKit.clickOnViewById(RIDConfigV600.ID_PERSONAL_SET);
			solo.sleep(PAUSE_TIME/2);
			solo.goBack();
			solo.sleep(PAUSE_TIME/2);
		}
